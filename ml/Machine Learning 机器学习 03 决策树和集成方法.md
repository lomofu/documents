...
![image-20211103225435763](img/03/image-20211103225435763.png)
...
![image-20211103231516863](img/03/image-20211103231516863.png)
...
3. 决策树形成过程中，每一个节点都按照步骤2来分裂（即下一次节点选出来的那个属性是刚父节点分裂时使用过的属性，则该节点已经达到戒子节点无需分裂）。**整个决策树形成过中没有剪枝**
